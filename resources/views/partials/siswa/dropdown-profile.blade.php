<button data-dropdown-toggle="profile {{ $size }}" data-dropdown-trigger="hover"
    class="text-white bg-myBlue focus:ring-4 focus:ring-blue-300 font-medium rounded-xl text-sm px-5 py-3 md:ms-3.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
